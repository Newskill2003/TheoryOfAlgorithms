...
<%@page import="TheoryOfAlgorithms.NewSkill.Lab4.Lab4"%>
...
<html>
    ...
    <body>
        ...
        <%! Lab4 lab4 = new Lab4("The Nissan Leaf, stylised as LEAF, is a compact"
        ...
        <p><b>Most popular words(6):</b> <%= lab4.GetFirstNMostPopularWords(6)%></p>
        <p><b>Number of words that do not contain letter (y):</b>
            <%= lab4.GetNumberOfWordsThatNotContain('y')%></p>
        <p><b>Number of words that contain 4 similar letters:</b>
            <%= lab4.GetNumberOfWordsThatContainSimilarLetters(4)%></p>
        <p><b>Most popular sequences (6):</b>
            <%= lab4.MostPopularSequences(6, 3)%></p>
    </body>
</html>
